    ...
    public partial class ProyectoopticaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ventum>(entity =>
            {
                ...
                entity.HasOne(d => d.IdUsuarioempleadoNavigation)
                    .WithMany(p => p.VentumIdUsuarioempleadoNavigations)
                    .HasForeignKey(d => d.IdUsuarioempleado)
                    .HasConstraintName("fk_v_idusuarioempleado");

                entity.HasOne(d => d.IdUsuariopacienteNavigation)
                    .WithMany(p => p.VentumIdUsuariopacienteNavigations)
                    .HasForeignKey(d => d.IdUsuariopaciente)
